...
class CV_English extends StatelessWidget {
  ...
  var name_style = TextStyle(
      color: title_white, fontSize: 25.0, fontFamily: 'Far');
  var developer_style = TextStyle(color: skill_color,
      fontSize: 15.0,
      fontFamily: 'IranSans',
      fontWeight: FontWeight.w300);
  var contact_me_style = TextStyle(fontSize: 15.0,
      color: title_white,
      fontFamily: 'IranSans',
      fontWeight: FontWeight.w300);
  var contact_me_style_hover = TextStyle(fontSize: 15.0,
      color: skill_color,
      fontFamily: 'IranSans',
      fontWeight: FontWeight.w300);
  ...
  Widget build(BuildContext context) {
    ...
    var row_social = Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          InkWell(
            onTap: () {
              _launchURL('https://github.com/zeinabtareek?tab=repositories');
            },
            child: Image.network(
          ...
          InkWell(onTap: () {
            _launchURL(
                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7NTh0uoUveiAxqtzkPh-dxQglSi_9iDwB9WLhHwrFlg&s');
          },
            child: Image.asset('assets/images/111.jpeg',
              width: icon_size,
              height: icon_size,
            ),
          ),
          SizedBox(width: sized_box_width,),
          Image.network(
            'https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Instagram_logo.png/240px-Instagram_logo.png',
            width: icon_size, height: icon_size,),
          SizedBox(width: sized_box_width,
          ),
    ...
    var col = Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: Text('Nagham Mohamed', style: name_style,),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: InkWell(
                    ...
                    child: Text_Icon('Contact me',
                        'https://1.bp.blogspot.com/-vzbIlZMkd6Q/X2jH2YDpa4I/AAAAAAAAS8E/WzBJZxCbDjIT5BIdqlzgJgmWAvli_ZZSQCLcBGAsYHQ/s2048/%25D9%2588%25D8%25A7%25D8%25AA%25D8%25B3%2B%25D8%25A7%25D8%25A8.png')),
              ),
              Container(
                  ...
                  child: InkWell(
                    ...
                    child: Text_Icon('Download resume',
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
          image: DecorationImage(
              image: NetworkImage(
                  'https://efdesign.hk/wp-content/uploads/2020/04/OGA3ET0.jpg'),
              fit: BoxFit.cover
          )
      ),
      child: Stack(
